  ...
  <div class="encode-wrap">
    ...
    <div class="button-wrap">
      ...
      >
        ...
        <div style="text-align: right; margin: 0">
          <el-button
            size="mini"
            type="text"
            @click="popover.isEncodeURI = false"
            >不转</el-button
          >
          <el-button
            type="primary"
            size="mini"
            @click="handleEncodeURI($event, 'isEncodeURI')"
            >转</el-button
          >
        </div>
        <el-button
      ...
      <el-popover
        ...
        width="200"
        trigger="manual"
        v-model="popover.isEncodeURIComponent"
      >
        <p>再转换一次？</p>
        <div style="text-align: right; margin: 0">
          <el-button
            size="mini"
            type="text"
            @click="popover.isEncodeURIComponent = false"
            >不转</el-button
          >
          <el-button
            type="primary"
            size="mini"
            @click="handleEncodeURI($event, 'isEncodeURIComponent')"
            >转</el-button
          >
        </div>
        <el-button
      ...
      >
        ...
        <div style="text-align: right; margin: 0">
          <el-button
            size="mini"
            type="text"
            @click="popover.isDecodeURI = false"
            >不转</el-button
          >
          <el-button
            type="primary"
            size="mini"
            @click="handleDecodeURI($event, 'isDecodeURI')"
            >转</el-button
          >
        </div>
        <el-button
      ...
      <el-popover
        ...
        width="200"
        trigger="manual"
        v-model="popover.isDecodeURIComponent"
      >
        <p>再转换一次？</p>
        <div style="text-align: right; margin: 0">
          <el-button
            size="mini"
            type="text"
            @click="popover.isDecodeURIComponent = false"
            >不转</el-button
          >
          <el-button
            type="primary"
            size="mini"
            @click="handleDecodeURI($event, 'isDecodeURIComponent')"
            >转</el-button
          >
        </div>
        <el-button
  ...
  methods: {
    handleEncodeURI(el, name) {
      ...
      if (this.topInput) {
        this.bottomInput =
          name == "isEncodeURI"
            ? encodeURI(this.topInput)
            : encodeURIComponent(this.topInput);
        //判断是否显示弹出框
    ...
    handleDecodeURI(el, name) {
      ...
      if (this.bottomInput) {
        this.topInput =
          name == "isDecodeURI"
            ? decodeURI(this.bottomInput)
            : decodeURIComponent(this.bottomInput);
        //判断是否显示弹出框
