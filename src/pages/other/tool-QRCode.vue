    ...
    <el-row>
      ...
      <el-col :xl="3" :lg="5" :offset="1" class="qrcode-wrap">
        ...
        <div class="qrcode" v-show="qrShow">
          ...
          ></vue-qr>
          <el-button type="success" @click="qrMoreSetting" class="qrMoreSetting"
            >更多设置</el-button
          >
          <el-button type="primary" @click="downloadFile" class="qrMoreSetting"
            >下载</el-button
          >
        </div>
      </el-col>
          ...
          <el-tabs v-model="tabsActive" stretch type="border-card">
            <el-tab-pane label="基本选项" name="first">
              <div class="dialog_option_wrap">
                ...
                <el-col :span="18">
                  <el-radio v-model="QRconfig.size" :label="200"
                    >小尺寸</el-radio
                  >
                  <el-radio v-model="QRconfig.size" :label="400">默认</el-radio>
                  <el-radio v-model="QRconfig.size" :label="700"
                    >大尺寸</el-radio
                  >
                  <el-radio v-model="QRconfig.size" :label="1000"
                    >超大尺寸</el-radio
                  >
                </el-col>
              </div>
              <div class="dialog_option_wrap">
                ...
                <el-col :span="18">
                  <el-radio v-model="QRconfig.correctLevel" :label="0"
                    >7%</el-radio
                  >
                  <el-radio v-model="QRconfig.correctLevel" :label="1"
                    >15%</el-radio
                  >
                  <el-radio v-model="QRconfig.correctLevel" :label="2"
                    >25%</el-radio
                  >
                  <el-radio v-model="QRconfig.correctLevel" :label="3"
                    >30%</el-radio
                  >
                </el-col>
              </div>
              <div class="dialog_option_wrap">
                <el-col :span="3" :offset="2" class="slider_label"
                  >外边距：</el-col
                >
                <el-col :span="18"
                  ><el-slider
            ...
            <el-tab-pane label="颜色" name="second">
              ...
              <div class="dialog_option_wrap">
                ...
                <el-col :span="18">
                  <el-color-picker
                    v-model="QRconfig.backgroundColor"
                  ></el-color-picker>
                </el-col>
              </div>
              <div class="dialog_option_wrap">
            ...
            <el-tab-pane label="logo" name="third">
              ...
              <div class="dialog_option_wrap" v-if="QRconfig.logoSrc">
                ...
                <el-col :span="18">
                  <el-slider
                    v-model="QRconfig.logoCornerRadius"
                    :min="0"
                    :max="50"
                  ></el-slider>
                </el-col>
